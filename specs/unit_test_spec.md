...
Extended timesheet columns: `employee_id, date, hours_normal, hours_ot_1_5, hours_ot_2_0, hours_sick, hours_annual, hours_unpaid, is_public_holiday`
...
```
tests/fixtures/
├── generated_supplementals/
│   ├── test_employees.tsv         # 26 synthetic employees
...
- [x] Entry Level (30k) — EXTERNALLY VALIDATED (Net Pay Kenya, HR Fleek)
- [x] Senior Executive (200k) — EXTERNALLY VALIDATED (Net Pay Kenya, HR Fleek)
- [x] C-Suite Level (500k) — EXTERNALLY VALIDATED (Net Pay Kenya, HR Fleek)
